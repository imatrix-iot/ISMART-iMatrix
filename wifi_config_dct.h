...
#define SOFT_AP_SSID         "iMatrix Connect Kit"
#define SOFT_AP_PASSPHRASE   "imatrix007"               // MUST BE @ Least 10 Characters
#define SOFT_AP_SECURITY     WICED_SECURITY_WPA2_AES_PSK
#define SOFT_AP_CHANNEL      1

/* This is the default AP the device will connect to (as a client)*/
#define CLIENT_AP_SSID       "SierraTelecom"
#define CLIENT_AP_PASSPHRASE "happydog"
